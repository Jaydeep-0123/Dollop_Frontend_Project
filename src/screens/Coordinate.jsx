...
import '../assets/styles/Coordinate.css'
const items = [
    ...
    <MainLayout>
      ...
      <div className=" rounded-2 bg-light text-start p-3">
        ...
        <div className=" shadow p-2 rounded-2">
          <h3 className="p-1 m-0 fw-bold">Jaydeep Panwar</h3>
          ...
          <table className="table ">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <Link className="text-decoration-none"  data-bs-toggle="modal" data-bs-target="#exampleModal">Pay Now</Link>
                </td>
              </tr>
              <tr>
                <td>2</td>
